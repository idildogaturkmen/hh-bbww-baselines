...
from scripts.analysis.hh4b_expected_limit import expected_upper_limit,expected_upper_limit_gamma,qmu_asimov
class Tests(unittest.TestCase):
 ...
 def test_gamma_finite_mc_is_weak_and_converges(self):
  stat=expected_upper_limit([10],[1000]); gamma=expected_upper_limit_gamma([10],[1000],[10000])
  self.assertGreater(gamma,stat)
  self.assertTrue(math.isclose(expected_upper_limit_gamma([10],[1000],[1e-4]),stat,rel_tol=1e-7))
