<!--
Provenance: copied verbatim from `docs/paper/track_b/LITERATURE_RESOURCES.md`
on `track-b-literature-resources-20260819`, tip commit
`34d261faab0f9d2ddc599eb660289abff7592ec8` (2026-08-19). That branch is
never merged; this is a preserved copy of the literature review backing
the Track-B / Sophon SPA-Net comparison work described below.
-->
