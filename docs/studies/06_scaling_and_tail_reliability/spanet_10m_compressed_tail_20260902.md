...
`docs/analysis/hh4b_spanet_compressed_tail_20260902_v1/README.md` on
`delphes-hh4b-production`, tip commit
`e17fdbf972f9517369eb79bc6c89b49e94172221` (2026-09-02, "Add SPA-Net
compressed-tail diagnostics"). That branch's tip commit is unique (not
present on `repo-reorg/2026-09`); this is a preserved copy of the
compressed-score-tail (u-transform) analysis of the governing SPA-Net
10M checkpoint. Internal file references (e.g. `work/*.json`,
`figures/*.png`) point to paths that exist only on the source branch,
not in this copy.
-->
