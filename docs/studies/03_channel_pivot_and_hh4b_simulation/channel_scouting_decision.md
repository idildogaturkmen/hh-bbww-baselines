<!--
Provenance: copied verbatim (no content edits) from
`notes/channel_scouting_decision.md` on `origin/pivot-channel-scouting`,
tip commit `6bf35191565db34336b4288c7a25afccffbd4565` (2026-07-02), the
first commit of that then-new branch (dated 2026-07-01 in its own header).
That branch is never merged; this is a preserved copy of the actual
channel-pivot decision document referenced narratively in this study's
README and in `docs/project_overview/physics_goal_and_pivot.md`. The
trailing Python fragment at the end of this file (a stray
`Path(...).write_text(...)` / `print(...)` snippet) is part of the
original committed content and is preserved as-is, not an artifact of
this copy.
-->
