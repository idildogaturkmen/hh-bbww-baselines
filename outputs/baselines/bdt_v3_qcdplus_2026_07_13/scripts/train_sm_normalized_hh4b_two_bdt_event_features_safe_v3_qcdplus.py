...
V2_PLUS_EXTRA_DIR = STORE / "parquet_v2_nominal_plus_extra"

BASE_SCRIPT = REPO / "scripts/delphes/train_sm_normalized_hh4b_two_bdt_event_features_safe.py"
OUTDIR = REPO / "outputs/tables/sm_normalized_hh4b_two_bdt_event_features_safe_v3_qcdplus_2026_07_13"
...
SAMPLES = [
    ...
    {
        "analysis_sample": "qcd_bbbb_iht200to400_combined220k_bdtv2",
        "group": "background",
        "n_generated": 220000,
        "xsec_pb": 126.37602476640181,
        "path": V2_PLUS_EXTRA_DIR / "qcd_bbbb_iht200to400_combined220k_bdtv2_hh4b_candidates.parquet",
    },
    {
        "analysis_sample": "qcd_bbbb_iht400to600_combined120k_bdtv2",
        "group": "background",
        "n_generated": 120000,
        "xsec_pb": 9.782172997792562,
        "path": V2_PLUS_EXTRA_DIR / "qcd_bbbb_iht400to600_combined120k_bdtv2_hh4b_candidates.parquet",
    },
    {
...
def load_all():
    ...
    print("\n=== V3 qcdplus BDT feature columns ===")
