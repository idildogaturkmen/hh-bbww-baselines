...
def main():
    ...
    outdir = repo / "outputs/tables" / f"hh4b_spanet_qcdplus_{args.tag}_2026_07_13"
    ...
    model = HH4BSPANet(input_dim=train_ds.X.shape[-1]).to(device)
