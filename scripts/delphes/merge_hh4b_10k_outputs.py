...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Merge and summarize 10k VBF HH4b Condor transfer outputs."
    )
    ...
    base = f"HH4b_{args.campaign}_cluster_{args.cluster}_shard_*_1000"
    ...
    out_prefix = f"HH4b_{args.campaign}_cluster_{args.cluster}_merged_10k"
