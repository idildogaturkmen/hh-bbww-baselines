...
REPO = Path.cwd()
INDIR = REPO / "outputs/tables/bdt_v3_qcdplus_categories_2026_07_13"
OUTDIR = REPO / "outputs/plots/bdt_v3_qcdplus_categories_2026_07_13"
OUTDIR.mkdir(parents=True, exist_ok=True)

df = pd.read_parquet(INDIR / "scored_test_events_bdt_v3_qcdplus.parquet")
...
plt.title("BDT-v3 qcdplus exclusive category sensitivity")
plt.tight_layout()
...
plt.xticks(rotation=35, ha="right")
plt.ylabel("S/B")
plt.title("BDT-v3 qcdplus exclusive category purity")
plt.tight_layout()
...
plt.title("BDT-v3 qcdplus category MC support")
plt.tight_layout()
...
ax.set_title("BDT-v3 qcdplus category background composition")
plt.xticks(rotation=35, ha="right")
plt.tight_layout()
...
plt.title("BDT-v3 qcdplus selected events in score plane")
