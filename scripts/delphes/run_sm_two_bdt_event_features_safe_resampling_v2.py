...
OUTDIR = REPO / "outputs/tables/sm_normalized_hh4b_two_bdt_event_features_safe_resampling_v2_2026_07_10"
...
WORKING_POINTS = [
    (0.800, 0.500, "loose_best_sqrtB"),
    (0.825, 0.525, "nominal_balanced"),
    (0.875, 0.750, "higher_purity"),
    (0.850, 0.750, "intermediate"),
]
