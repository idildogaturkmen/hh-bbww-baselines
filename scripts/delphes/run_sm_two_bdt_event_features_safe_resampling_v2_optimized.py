...
OUTDIR = REPO / "outputs/tables/sm_normalized_hh4b_two_bdt_event_features_safe_resampling_v2_optimized_2026_07_10"
...
WORKING_POINTS = [
    (0.700, 0.500, "v2_single_seed_best"),
    (0.725, 0.500, "v2_single_seed_next"),
    (0.775, 0.500, "v2_loose_mid"),
    (0.800, 0.500, "v2_loose_best_sqrtB"),
    (0.825, 0.525, "v2_nominal_balanced"),
    (0.825, 0.550, "v2_multiseed_median_best"),
    (0.850, 0.550, "v2_tighter_qcd"),
    (0.875, 0.750, "v2_higher_purity"),
]
