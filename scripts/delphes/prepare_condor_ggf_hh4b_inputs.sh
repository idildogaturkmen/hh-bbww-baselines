...
MG5_TEMPLATE="${MG5_TEMPLATE:-$HH4B_STORE/mg5/HH4b_ggf_heft}"

CONDOR_INPUT_DIR="${CONDOR_INPUT_DIR:-$HH4B_STORE/condor_inputs}"
TARBALL="${TARBALL:-$CONDOR_INPUT_DIR/hh4b_ggf_heft_condor_inputs.tar.gz}"
SAMPLE_LABEL="HEFT ggF HH -> 4b approximation"
...
sample=$SAMPLE_LABEL
production_mode=ggF
ggf_model=HEFT/effective ggF approximation
EOF
