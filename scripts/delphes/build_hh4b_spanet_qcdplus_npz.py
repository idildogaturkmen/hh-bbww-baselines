...
def sample_configs(store):
    return [
        ...
        },
        {
            ...
            "n_generated": 20000,
            "patterns": ["qcd_bbbb_iht100to200_20000_pythia8_delphes.root"],
        },
        {
            "sample": "qcd_bbbb_iht200to400_combined220k_rootkeep_v1",
            "group": "background",
            "xsec_pb": 126.41079330444336,
            "n_generated": 220000,
            "patterns": [
        ...
        {
            "sample": "qcd_bbbb_iht400to600_combined120k_rootkeep_v1",
            "group": "background",
        ...
        },
        {
            ...
            "n_generated": 20000,
            "patterns": ["qcd_bbbb_iht600plus_20000_pythia8_delphes.root"],
        },
    ]
