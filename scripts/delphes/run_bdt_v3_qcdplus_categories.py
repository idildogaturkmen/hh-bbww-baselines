...
"""
BDT-v3 qcdplus categorized audit.
...
V3_SCRIPT = REPO / "scripts/delphes/train_sm_normalized_hh4b_two_bdt_event_features_safe_v3_qcdplus.py"

OUTDIR = REPO / "outputs/tables/bdt_v3_qcdplus_categories_2026_07_13"
...
def main():
    ...
    scored_path = OUTDIR / "scored_test_events_bdt_v3_qcdplus.parquet"
    test_df.to_parquet(scored_path, index=False)

    auc_summary = pd.DataFrame([
        {
            "classifier": "BDT_QCD_event_features_safe_v3_qcdplus",
        ...
        {
            "classifier": "BDT_top_event_features_safe_v3_qcdplus",
    ...
    readme.write_text(
        "# BDT-v3 qcdplus categorized audit\n\n"
        "This directory contains HHH-style mutually exclusive categories built from the two BDT-v3 qcdplus scores.\n\n"
        "The script reproduces the frozen BDT-v3 qcdplus train/test split and saves the scored test dataframe.\n\n"
        "Files:\n"
        "- scored_test_events_bdt_v3_qcdplus.parquet\n"
