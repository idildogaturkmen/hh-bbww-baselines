...
FEATURE_LATEX_LABELS: dict[str, str] = {
    ...
    "dr_j1_j2": r"$\Delta R(j_1,j_2)$",
    "dr_j1_j3": r"$\Delta R(j_1,j_3)$",
    "dr_j1_j4": r"$\Delta R(j_1,j_4)$",
    "dr_j2_j3": r"$\Delta R(j_2,j_3)$",
    "dr_j2_j4": r"$\Delta R(j_2,j_4)$",
    "dr_j3_j4": r"$\Delta R(j_3,j_4)$",
    "min_candidate_pair_dr": r"$\min\,\Delta R_{jj}$",
    "max_candidate_pair_dr": r"$\max\,\Delta R_{jj}$",
    "mean_candidate_pair_dr": r"$\langle\Delta R_{jj}\rangle$",
    "min_cross_higgs_pair_dr": r"$\min\,\Delta R_{jj}^{\mathrm{cross}}$",
    "max_cross_higgs_pair_dr": r"$\max\,\Delta R_{jj}^{\mathrm{cross}}$",
    "candidate_vector_pt_sum": r"$|\sum_{j=1}^{4}\vec{p}_{\mathrm{T}}^{\,j}|$",
    "cos_theta_star_h1_in_hh_rest": r"$\cos\theta^{*}_{H_1}$",
    "abs_cos_theta_star_h1_in_hh_rest": r"$|\cos\theta^{*}_{H_1}|$",
    "cos_theta_j1_in_h1_rest": r"$\cos\theta_{j_1}^{H_1}$",
    "abs_cos_theta_j1_in_h1_rest": r"$|\cos\theta_{j_1}^{H_1}|$",
    "cos_theta_j_h2_leading_in_h2_rest": r"$\cos\theta_{j_{\mathrm{lead}}}^{H_2}$",
    "abs_cos_theta_j_h2_leading_in_h2_rest": r"$|\cos\theta_{j_{\mathrm{lead}}}^{H_2}|$",
}
